...
var table = function(config) {
        this.appendUnder = config.appendUnder;
        this.thead = config.data.thead;
        this.tbody = config.data.tbody;
        this.IsEnableSort = config.IsEnableSort;
        this.SetHeadColor = config.SetHeadColor;
        this.ele = null;
